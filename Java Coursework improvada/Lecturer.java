public class Lecturer extends Teacher         //inheritance
{
    ...
    public Lecturer(int teacher_id, String teacher_name, String address, String working_type, int working_hours, String employment_status, String department, int years_of_experience)
    {                                                                     //constructor^
