...
public class TeacherGUI {
    ...
    private JTextField lId, lName, lAddress, lWorkingType, lEmploymentStatus, lDepartment, lExperience,  lWorkingHours;
    ...
    public TeacherGUI() {
        ...
        addLecturerButton.setBounds(62, 130, 150, 30);
        //for adding tutor
        addTutorButton = new JButton("Add Tutor");
        addTutorButton.setBounds(377, 130, 140, 30);
        //for grading assignment
        gradeButton = new JButton("Grade Assignment");
        gradeButton.setBounds(62, 197, 190, 30);
        //for setting salary
        setSalaryButton = new JButton("Set Salary");
        setSalaryButton.setBounds(377, 197, 150, 30);
        //for removing tutor
        removeTutorButton = new JButton("Remove Tutor");
        removeTutorButton.setBounds(62, 264, 150, 30);
        //exiting frame
        exitButton = new JButton("Exit");
        exitButton.setBounds(377, 264, 100, 30);
        ...
        mainPanel.setBackground(new Color(47, 79, 79)); //setting background to darkish green of panel
        ...
        mainPanel.add(removeTutorButton);
        mainPanel.add(addTutorButton);
        mainPanel.add(setSalaryButton);
        mainPanel.add(exitButton);
         
        //adding the main panel to the frame's content pane
        buttonsFrame.add(mainPanel);
    ...
    public void lecturersFrame() {
        ...
        lAddButton.setBounds(160, 395, 130, 33);
        lDisplayButton = new JButton("Display");
        lDisplayButton.setBounds(360, 395, 120, 33);
        lClearButton = new JButton("Clear");
        lClearButton.setBounds(550, 395, 120, 33);
        ...
        lAddButton.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent a)
            {
                try {
                    ...
                    if(lId.getText().trim().equals("") || lName.getText().trim().equals("") || lAddress.getText().trim().equals("") || lWorkingType.getText().trim().equals("") || lExperience.getText().trim().equals("") || lDepartment.getText().trim().equals("") || lWorkingHours.getText().trim().equals("") || lEmploymentStatus.getText().trim().equals("") ) {
                        ...
                        int lIdAvailable = Integer.parseInt(lId.getText()); //creating a variable and putting lecturer id on it
                        int experienceL = Integer.parseInt(lExperience.getText().trim());
                        int  workingHoursL = Integer.parseInt(lWorkingHours.getText().trim());
                        String nameL = lName.getText().trim();
                        String addressL = lAddress.getText().trim();
                        String departmentL = lDepartment.getText().trim();
                        String workingTypeL = lWorkingType.getText().trim();
                        String employmentStatusL = lEmploymentStatus.getText().trim();
                                
                        if (lIdAvailable >=0 && workingHoursL >=0) {
                            ...
                            if (isAdded == true) {
                                ...
                                Lecturer lecturer = new Lecturer(lIdAvailable, nameL, addressL, workingTypeL, workingHoursL, employmentStatusL, departmentL,  experienceL);
                                listOfTeacher.add(lecturer);
                            ...
                            JOptionPane.showMessageDialog(salaryFrame, "Please enter positive values.");
                        }
                    }
        ...
        lClearButton.addActionListener(new ActionListener()
        {
            ...
            {
                if(!lId.getText().equals("") || !lName.getText().equals("") || !lAddress.getText().equals("") || !lWorkingType.getText().equals("") || !lDepartment.getText().equals("") || !lExperience.getText().equals("") || !lWorkingHours.getText().equals("") || !lEmploymentStatus.getText().equals("") ){
    ...
    public void displayLecturerList() {
        ...
        //adding to frame
        lDisplayFrame.add(lDisplayPanel);
    ...
    public void displayTutorList() {
        ...
        //adding to frame
        tDisplayFrame.add(tDisplayPanel);
        ...
        tAddButton.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent a)
            {
                try {
                    ...
                    else {//trim function removes un-needed whitespaces in front of and behind inputs
                        int performanceT = Integer.parseInt(tPerformance.getText().trim());
                        int salaryT = Integer.parseInt(tSalary.getText().trim());
                        int workingHoursT = Integer.parseInt(tWorkingHours.getText().trim());
                        String nameT = tName.getText().trim();
                        String addressT = tAddress.getText().trim();
                        String specializationT = tSpecialization.getText().trim();
                        String workingTypeT = tWorkingType.getText().trim();
                        String employmentStatusT = tEmploymentStatus.getText().trim();
                        String qualificationT = tQualification.getText().trim();
                        int tIdAvailable = Integer.parseInt(tId.getText());
                        
                        if (tIdAvailable >=0 && salaryT >=0 && performanceT >=0 && workingHoursT >=0) {
                            boolean isAdded = true;
                            for(int i=0; i<listOfTeacher.size(); i++) {
                            ...
                            if (isAdded == true) {
                                ...
                                Tutor tutor = new Tutor(tIdAvailable, nameT, addressT, workingTypeT, employmentStatusT, workingHoursT, salaryT, specializationT, qualificationT, performanceT);
                                listOfTeacher.add(tutor);
            ...
            public void actionPerformed(ActionEvent a)
            {
                try 
                {
                    if( (gId.getText().trim().equals("")) || (gDepartment.getText().trim().equals("")) || (gGradedScore.getText().trim().equals("")) || (gExperience.getText().trim().equals("")) ) {
                        ...
                        int experienceCheck = Integer.parseInt(gExperience.getText().trim());
                        int gradedScoreCheck = Integer.parseInt(gGradedScore.getText().trim());
                        int idCheck = Integer.parseInt(gId.getText().trim());
                        String resultingGrade = "";
                        
                        if (idCheck >=0 && experienceCheck >=0 && gradedScoreCheck >= 0) {
            ...
            public void actionPerformed(ActionEvent a)
            {
                try {
                    if( sId.getText().trim().equals("") || sPerformance.getText().trim().equals("") || sSalary.getText().trim().equals("") ) {
                        ...
                        //setting salary code
                        int idCheck = Integer.parseInt(sId.getText().trim());
                        double salaryCheck = Integer.parseInt(sSalary.getText().trim());
                        int performanceCheck = Integer.parseInt(sPerformance.getText().trim());
                        String updatedSalary = "";
                        
                        if (idCheck >=0 && salaryCheck >=0 && performanceCheck >=0) {
                            //iterating through the arraylist and checking if each is instance of lecturer
                            for(int i=0; i<listOfTeacher.size(); i++) {
                            ...
                            if(updatedSalary.equals("")) {
                                ...
                                else if (performanceCheck < 5){
                                    JOptionPane.showMessageDialog(salaryFrame, updatedSalary);
                                }
                                
                                else {
                                    JOptionPane.showMessageDialog(salaryFrame, "Unexpected Error");
                                }
                            }
                        }
            ...
            public void actionPerformed(ActionEvent a)
            {
                try {
                    if( rId.getText().trim().equals("") ) {
                        ...
                        int idR = Integer.parseInt(rId.getText().trim());
                        if (idR >=0) {
                            //removing code
                            boolean isRemoved = false;
                            for(int i=0; i<listOfTeacher.size(); i++) {
                                if ( idR == listOfTeacher.get(i).getTeacher_id() && listOfTeacher.get(i) instanceof Tutor ) {
