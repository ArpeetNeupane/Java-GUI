...
def renting():
    ...
    """
    continueOperationBool = True
    while continueOperationBool == True:
                    ...
                    while repeatRent == True:
                            ...
                            if rentAgain.lower() == "y":
                                ...
                                while continueAgain == True:
                                    continueOperation = input("\nDo you want to continue to rent? (y/n): ")
                                    if continueOperation.lower() == "y":
                                        ...
                                        continueOperationBool = True
                                        continueAgain = False
                                    elif continueOperation.lower() == "n":
                                        continueOperationBool = False
                                        continueAgain = False
                                    else:
                                        print("Type option 'y' for yes and 'n' for no")
            ...
            try:
                ...
                while repeatReturn == True:
                    ...
                    if returnLandRepeat.lower() == "y":
                        ...
                        continueAgain = True
                        while continueAgain == True:
                            continueOperation = input("\nDo you want to continue to return? (y/n): ")
                            if continueOperation.lower() == "y":
